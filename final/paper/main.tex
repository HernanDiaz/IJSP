...
insensitive to the exact threshold in the range that matters: at $0.05\%$
the count of converged cells is 114 and at $0.25\%$ it is 162, against 133
at the $0.1\%$ used here. Per-cell classifications are released with the
data.
...
7.58); over the 12 instances where that control actually converges the
ordering reverses and the mixed pool beats it by 0.75 points (4.00 against
4.75). The negative result for the GA is therefore a statement about
...
cells where it is given that time the harm disappears. This revises the
reading of Section~\ref{sec:whyga}: what the GA lacks is not compatibility
with heterogeneous parents in principle, but enough generations to exploit
them under these budgets.
...
over the 39 converged instances the control is best and the margin vanishes
(2.75 against 2.78). The 22 cells TSN2 fails are its largest --- all ten
