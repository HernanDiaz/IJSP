...
//=============================================================================
/**
* This class defines a specific type of neighbour for JSP problems.
...
*
*/
class NeighbourJSP_Arc : public FuzzyFW::Neighbour {
	//=========================================================================
	//		FIELDS
	//=========================================================================
public:
...
public:
	...
	* Default constructor.
	*/
	explicit NeighbourJSP_Arc()
		: Neighbour(), x(0), y(0), z(0), tipo(0)  { }
		
	/*
	* Main constructor.
	*/
	explicit NeighbourJSP_Arc(const int x, const int y, const int z=0, const int tipo=0)
		: Neighbour(), x(x), y(y), z(z), tipo(tipo) { }

	/**
	* Copy constructor
	*/
	NeighbourJSP_Arc(const NeighbourJSP_Arc &source);

	/**
	* Clone method for inheriting classes
	*/
	virtual Neighbour * clone() const {
		return new NeighbourJSP_Arc(*this);
	}

	/**
	* Destructor. Nothing to do here
	*/
	virtual ~NeighbourJSP_Arc() { }
