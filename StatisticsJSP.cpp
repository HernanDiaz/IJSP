...
StatisticsMakespan::StatisticsMakespan(STAT_TYPE flag)
	...
	newParams->setParameter(JSP_EVALUATION_COMPARE, "EV");
	newParams->setParameter(JSP_EVALUATION_MAXIMUM, "COMPONENT");
	newParams->setParameter(FUZZYFW_EVALUATION_LAMARCK, "NO");
	this->evaluation = new EvaluationJSP_Makespan(newParams);
}
