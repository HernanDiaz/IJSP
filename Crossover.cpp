...
//=============================================================================
//=====  Apply (Individual)  ==================================================
void Crossover_GOXBierwirth::apply(Individual *ind1, Individual *ind2,
	const SharedVars *svars) const {
...
//=====  Apply (Permutation)  =================================================
void Crossover_GOXBierwirth::applyPermutation(IndividualArrayInt *ind1,
	IndividualArrayInt *ind2, const SharedVars *svars) const {
...
//=====  Apply (Permutation with Repetitions)  ================================
void Crossover_GOXBierwirth::applyJobPermutation(IndividualArrayInt *ind1,
	IndividualArrayInt *ind2, const SharedVars *svars) const {
...
//=============================================================================
//=====  Apply (Individual)  ==================================================
void Crossover_GPMXBierwirth::apply(Individual *ind1, Individual *ind2,
	const SharedVars *svars) const {
...
//=====  Apply (Permutation)  =================================================
void Crossover_GPMXBierwirth::applyPermutation(IndividualArrayInt *ind1,
	IndividualArrayInt *ind2, const SharedVars *svars) const {
...
//=====  Apply (Permutation with Repetitions)  ================================
void Crossover_GPMXBierwirth::applyJobPermutation(IndividualArrayInt *ind1,
	IndividualArrayInt *ind2, const SharedVars *svars) const {
...
//=============================================================================
//=====  Apply (Individual)  ==================================================
void Crossover_PPXBierwirth::apply(Individual *ind1, Individual *ind2,
	const SharedVars *svars) const {
...
//=====  Apply (Permutation)  =================================================
void Crossover_PPXBierwirth::applyPermutation(IndividualArrayInt *ind1,
	IndividualArrayInt *ind2, const SharedVars *svars) const {
...
//=====  Apply (Permutation with Repetitions)  ================================
void Crossover_PPXBierwirth::applyJobPermutation(IndividualArrayInt *ind1,
	IndividualArrayInt *ind2, const SharedVars *svars) const {
