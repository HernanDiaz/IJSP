...
(results/EXP4_TUNED_TSN2ANCHOR) against the three original tuned arms
...
STRONG = os.path.join(HERE, "results", "EXP4_TUNED_TSN2ANCHOR")
...
print("=" * 78)
print("M9: escalera ANCLA-TSN2 (LADDER+) vs brazos originales — HV ratio")
print("=" * 78)
