...
# Paper arm: the PUBLISHED N2 neighbourhood (N2Plus is not published yet).
SETUP="${EXP_DIR}/setup/setup_LexME_N2ME_tuned.txt"
RESULTS_DIR="${EXP_DIR}/results/LexME_N2ME"
BASELINE_CSV="${REPO}/experiments/cor_tabu_2026/statistical_results/runs_data.csv"
LOG_FILE="${EXP_DIR}/run_n2me.log"
...
for i in "${!P_INST[@]}"; do
    ...
    plog="${EXP_DIR}/results/logs/LexME_N2ME__${iname}.log"
