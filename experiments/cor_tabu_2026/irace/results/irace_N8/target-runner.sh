...
# Default 900s covers N2/Next/N8 (tai50 ~430s observed).
# N1 and N3 evaluate ~2.8x more moves per LS step → use 2500s.
# Override via IRACE_TIMEOUT env variable set in run_irace.sh per neighbourhood.
