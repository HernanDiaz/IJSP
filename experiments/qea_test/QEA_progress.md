...
- **Mejor versión actual (baseline): posicional, samples schedule 100→400 cosine (avg 250), rotación cosine 0.02→0.08, floor constante 0.005, sampling τ 0.7→1.3 → AvgRE 11.98%.** Brecha con GA puro: ~2.20 puntos. El QEA puro ya está cerca del GA puro por primera vez.
