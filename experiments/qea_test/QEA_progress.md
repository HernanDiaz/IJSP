...
- **Mejor versión actual (baseline): posicional, samples schedule 100→400 cosine (avg 250), rotación cosine 0.02→0.08, floor constante 0.005 → AvgRE 13.54%.** Brecha con GA puro: ~3.76 puntos.
