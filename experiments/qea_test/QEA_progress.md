...
- **Mejor versión actual (baseline): posicional, población 250, rotación schedule 0.02→0.08, floor schedule 0.02→0.005 → AvgRE 14.69%.** Brecha con GA puro: ~4.9 puntos.
