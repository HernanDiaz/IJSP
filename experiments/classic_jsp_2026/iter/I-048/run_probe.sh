#!/bin/bash
# I-048: the ABC -> CP-SAT hybrid on the open 30x15 instances.
# Fixed before running: ta32 ta33 ta34 ta40, the 6 lowest distinct schedules
...
I=iter/I-048
LOG=$I/probe_run.log
echo "=== I-048 probe start at $(date) ===" > $LOG
...
for inst in ta32 ta33 ta34 ta40; do
...
echo "=== I-048 probe exit at $(date) ===" >> $LOG
