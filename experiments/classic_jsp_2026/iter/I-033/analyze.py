#!/usr/bin/env python3
"""I-033: the pre-declared analysis of the hunt.
...
3. Best of the 400 and the lower quantiles of the run distribution, so the
...
def main():
    ...
    for inst in INSTANCES:
        ...
        for path in sorted(glob.glob(os.path.join(
                EXPERIMENT, "results", "I-033_c*", inst + "_*_Certificate.csv"))):
