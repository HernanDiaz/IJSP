#!/bin/bash
# I-049: the ABC -> CP-SAT hybrid with many hints and little time each.
# Fixed before running: ta33 ta34, the 40 lowest distinct schedules
...
I=iter/I-049
LOG=$I/probe_run.log
echo "=== I-049 probe start at $(date) ===" > $LOG
...
echo "=== I-049 probe exit at $(date) ===" >> $LOG
