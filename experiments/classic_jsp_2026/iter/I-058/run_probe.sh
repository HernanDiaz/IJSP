#!/bin/bash
# I-058: the ABC -> CP-SAT hybrid with many hints and little time each.
# Fixed before running: ta22 ta26, the 40 lowest (feasible) distinct schedules
...
I=iter/I-058
LOG=$I/probe_run.log
echo "=== I-058 probe start at $(date) ===" > $LOG
...
echo "=== I-058 probe exit at $(date) ===" >> $LOG
