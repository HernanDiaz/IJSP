#!/bin/bash
# I-063: the ABC -> CP-SAT hybrid on the open 30x20 instances not yet polished.
# Fixed before running: ta41 ta43 ta46 ta47 ta48, the 6 lowest (feasible) distinct schedules
...
I=iter/I-063
LOG=$I/probe_run.log
echo "=== I-063 probe start at $(date) ===" > $LOG
...
for inst in ta41 ta43 ta46 ta47 ta48; do
...
echo "=== I-063 probe exit at $(date) ===" >> $LOG
