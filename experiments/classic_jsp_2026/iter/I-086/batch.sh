#!/bin/bash
# The ta27 machine-pair campaign (I-082 on): pairs.txt (all 190 pairs, round 3 from 1680; was 187 in I-082, the three of
...
echo "=== I-086 pairs $F-$L start at $(date) ===" > $LOG
...
echo "=== I-086 pairs $F-$L exit at $(date) ===" >> $LOG
