 ...
 *
 */
struct JSPClassRegister {
protected:
	// Methods to create an instance of different operators.
	//=========================================================================
	template<typename T>
	static SGS_JSP * createSGSInstance() { return new T; }
	...
	//=========================================================================
	static std::map<std::string, SGS_JSP*(*)()> SGSMap;
...
public:
	...
	*/
	...
	static SGS_JSP * getSGSObject(std::string name) {
		std::map<std::string, SGS_JSP*(*)()>::iterator iter;
		iter = JSPClassRegister::SGSMap.find(toUpper(name));
		if (iter == SGSMap.end())
			return NULL;
		return iter->second();
	}
	...
	static void registerClasses() {
		...
		SGSMap[toUpper("insertion")] = &createSGSInstance<SGS_JSP_Insertion>;
		SGSMap[toUpper("active")] = &createSGSInstance<SGS_JSP_Insertion>;
		SGSMap[toUpper("append")] = &createSGSInstance<SGS_JSP_Append>;
		SGSMap[toUpper("semi")] = &createSGSInstance<SGS_JSP_Append>;
		SGSMap[toUpper("semi-active")] = &createSGSInstance<SGS_JSP_Append>;
		SGSMap[toUpper("semiactive")] = &createSGSInstance<SGS_JSP_Append>;
	}
