...
*/
#ifndef DUEDATE_CLASSREGISTER_H_
#define DUEDATE_CLASSREGISTER_H_
	...
	public:
		...
		*/
		static DueDate * getDueDateObject(std::string name) {
			...
			iter = DueDateClassRegister::DueDateMap.find(toUpper(name));
...
#endif /* DUEDATE_CLASSREGISTER_H_ */
