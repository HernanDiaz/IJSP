...
#include "NeighbourhoodJSP_helpers.h"

namespace JSP {

//=============================================================================
//
//	Class NB_ParallelBase_MakespanJSP
//
//=============================================================================
/**
 * Abstract base for all Makespa JSP parallel neighbourhood classes.
 ...
 * @author hdiaz
 */
class NB_ParallelBase_MakespanJSP : public FuzzyFW::Neighbourhood {
protected:
	...
	std::vector<std::unique_ptr<NeighbourJSP_Arc>> neighbours;
	...
	//=========================================================================
public:
	NB_ParallelBase_MakespanJSP(FuzzyFW::ParameterDB *parameters = NULL)
	...
	NB_ParallelBase_MakespanJSP(const NB_ParallelBase_MakespanJSP &source);

	virtual void setup(FuzzyFW::ParameterDB *parameters);

	virtual ~NB_ParallelBase_MakespanJSP();
