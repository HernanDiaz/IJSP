...
class FuzzyProblem : public Problem {
	//=====================================================================
	//		FIELDS
	//=====================================================================
protected:
	...
	*/
	std::vector<FuzzyTask *> task;

	/**
	* Due-dates of the problem
	*/
	std::vector<DueDate *> dueDate;
...
public:
	...
	* Default constructor
	*/
	FuzzyProblem(const ParameterDB *params = NULL);
	...
	*/
	FuzzyProblem(const ParameterDB *params, const char *inputFile);


	/**
	* Copy constructor
	*/
	FuzzyProblem(const FuzzyProblem & source);
...
public:
	...
	* allowed
	*/
	const FuzzyTask * operator[](const int taskId) const {
...
public:
	...
	*/
	virtual void loadFile(const char *inputFile);
...
#endif /* FJSPPROBLEM_FUZZYPROBLEM_H_ */
