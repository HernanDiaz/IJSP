...
class SGS_Split_FD_Time : public SGS_FVRP
{
	//=========================================================================
	//		FIELDS
	//=========================================================================
...
public:
	...
	* Default constructor
	*/
	SGS_Split_FD_Time(const FuzzyFW::ParameterDB *params = NULL);


	/*
	* Copy constructor
	*/
	SGS_Split_FD_Time(const SGS_Split_FD_Time &source);


	/*
	* Clone method to replicate inherited instances
	*/
	virtual SGS_Split_FD_Time * clone() const {
		return new SGS_Split_FD_Time(*this);
	}
	...
	* Destructor
	*/
	virtual ~SGS_Split_FD_Time() { }  // No pointers, no destruction
...
class SGS_Split_FD_Distance : public SGS_Split_FD_Time
{
	//=========================================================================
	//		CONSTRUCTORS / INITIALIZERS
	//=========================================================================
public:
	...
	* Default constructor
	*/
	SGS_Split_FD_Distance(const FuzzyFW::ParameterDB *params = NULL)
		: SGS_Split_FD_Time(params) { }


	/*
	* Copy constructor
	*/
	SGS_Split_FD_Distance(const SGS_Split_FD_Distance &source)
		: SGS_Split_FD_Time(source) { }


	/*
	* Clone method to replicate inherited instances
	*/
	virtual SGS_Split_FD_Distance * clone() const {
		return new SGS_Split_FD_Distance(*this);
	}
	...
	*/
	virtual void setup(const FuzzyFW::ParameterDB *params) {
		SGS_Split_FD_Time::setup(params);
	}
	...
	* Destructor
	*/
	virtual ~SGS_Split_FD_Distance() { }  // No pointers, no destruction
...
public:
	...
	*/
	virtual std::vector<std::string> getName() const {
		std::vector<std::string> setup;
		setup.push_back("Split-FD-Distance");
		if (this->metricDemand == FD_NECESSITY)
			setup.push_back(";Demand Metric:;" + std::string(FVRP_DEMAND_NEC));
		else if (this->metricDemand == FD_POSSIBILITY)
			setup.push_back(";Demand Metric:;" + std::string(FVRP_DEMAND_POS));
