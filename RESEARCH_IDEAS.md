...
| I-033 | **caza en `ta18`** (15x15), la única instancia abierta que la línea no había tocado, 400 tiradas de 40 s, semillas 9001-9400 | 19 unidades de margen hasta la cota; pequeña, así que las tiradas cortas rinden; improbable, y barata | -- | pendiente | **lanzada** (2026-09-24) |
...
`taillard_bounds.csv` da `ta18` (15x15) como abierta: BKS 1396, cota 1377,
...
minutos. **Declarado antes**: una 15x15 tan estudiada es improbable que caiga;
se corre porque es barata y es la única oportunidad de récord sin mirar.

No hay presupuesto de clase para 15x15; se declaran **40 s por tirada**, el de
