...
| I-052 | **la aleatoriedad de CP-SAT**: las pistas que dieron 1603 (`ta25`), 1653 (`ta26`) y 1685 (`ta27`), con las semillas 2 a 13, 45 s cada una | la misma pista con otra semilla puede caer en otro fondo | pendiente | no aplica | **lanzada** (2026-09-25) |
