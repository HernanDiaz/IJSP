...
| I-083 | **descenso en `ta27`, vuelta 2**: grupo + el 1684, las 20 máquinas sueltas, 60 s | el 1684 cambia el núcleo | **18 de 20 máquinas OPTIMAL en 1684**; abiertas la 15 (cota 1683) y la 17 (cota 1680); ninguna mejora | no aplica | **cerrada** (2026-09-26); sigue I-084 |
...
| I-074 | **descenso en `ta18`, vuelta 3**: grupo + el 1401, máquinas sueltas (60 s) y parejas 1-35 (45 s) | el 1401 cambia el núcleo | máquinas sueltas: **15 de 15 OPTIMAL en 1401**; parejas 1-35: **34 OPTIMAL en 1401**, 1 abierta (0,13) cota 1398; ninguna mejora | no aplica | **cerrada** (2026-09-25); sigue I-075 (parejas 36-70) |
...
### I-034, cierre: exploradores pulidos, descartada y revertida

Filtro y seis oleadas, 1500 tiradas, cero infactibles, control en `ref_I-021`.
Media por instancia `polish − control`: filtro +0.03, mirillas −0.14, −0.11,
−0.10, +0.21, +0.30, **+0.31**, con p final **0.056** y mejor en solo 6 de 21.
**No cruza, y termina del lado del control.** El mecanismo se ejerció siempre,
unos 203 exploradores pulidos por tirada.

**Lo que dice**: meter en la población óptimos locales nuevos e independientes
—un reinicio pulido por cada fuente agotada— **no mejora el resultado**, y si
acaso lo empeora un poco. Con I-003 e I-014 (reinyectar alrededor de lo que ya
hay), I-016 (mejores aleatorios) e I-031 (cruzar por distancia), son cinco
formas distintas de **mover la búsqueda hacia otras cuencas desde dentro de la
población**, y ninguna ayuda: la población vigente ya reparte bien su
exploración, y lo que añade profundidad sobre lo mejor que tiene (I-018, I-021)
es lo único que ha funcionado.

**Sin récords**; la única igualada es la conocida de `ta30`, semilla 1009.
...
### I-035, filtro: pasa, pero en contra

240 trabajos, cero infactibles, semillas 1001 a 1030, control en `ref_I-021`.
**Mecanismo, ejercido**: unas 15000 segundas parejas elegidas por tirada (de
10556 a 26387), con el mejor hijo **43-46 unidades mejor en bruto**, y más
generaciones (77 → 93 en ta23, 189 → 216 en ta45). Media por instancia
`pair − control`: ta23 −1.03, ta29 +1.57, ta30 +2.70, ta45 +1.27, **+1.13**;
regla *descartar si > +2.0*: **pasa**, que aquí solo significa que no descarta,
porque la dirección es la contraria a la hipótesis y la cola informada va
peor todavía (+3.29, con ta30 +11.33). Empezar la cadena desde un hijo mejor
**en bruto** no parece traducirse en un óptimo mejor. Van las oleadas, que es
lo que dice la regla.

### I-035, cierre: dos cruces por fuente, descartada y revertida

Filtro y seis oleadas, 1500 tiradas, cero infactibles, control en `ref_I-021`.
Media por instancia `pair − control`: filtro +1.13, mirillas +1.01, +0.49,
+0.75, +1.30, +0.96, **+0.80**, con p final **0.099** y mejor en solo 7 de 21.
**No cruza, y termina del lado del control**; en las mirillas 4 y 5 rozó la
frontera de daño (p = 0.033 y 0.039). El mecanismo se ejerció siempre, unas
18400 segundas parejas elegidas por tirada.

**Lo que dice**: empezar la cadena profunda desde un hijo **mejor en bruto**
(unas 45 unidades) no lleva a un óptimo mejor, y el coste del segundo cruce y
su evaluación, más la pérdida de variedad en los puntos de partida, lo
empeoran algo. La calidad en bruto del punto de partida no predice la calidad
del óptimo al que llega la cadena.
...
### I-037 — una llamada de profundidad doble antes de que acabe la cadena

**De dónde sale**: lo único aceptado es **profundidad sobre lo mejor** que la
población tiene (I-018, I-021), y lo que ha fallado después es todo lo que la
mueve hacia otras cuencas (I-031, I-034), le da mejores puntos de partida
(I-035) o recombina de otra manera (I-036). El backlog se ha agotado; queda
viva la forma **asimétrica** de B-9, que irace no pudo explorar porque en su
espacio la profundidad era una sola para toda la población (H-5). Leyendo
`LS_Tabu::apply`: cada llamada vacía la lista tabú y muere tras 15
iteraciones sin mejorar, y la cadena de I-021 termina en **la primera llamada
que no mejora**.

**La idea**: `abc.ls.escalate = double`. Esa llamada fallida va seguida de
**una** llamada sobre el mismo hijo con el **doble de profundidad**
(`bad-iterations` 30 en vez de 15); si mejora, la cadena sigue a la
profundidad normal, y solo termina cuando falla una llamada doble. El 2 se
fija de antemano. No es I-009 (una llamada profunda por tirada,
infradimensionada) ni I-023 (patada y reoptimización al final de la cadena):
aquí no se perturba nada, se busca más hondo desde el mismo sitio, miles de
veces por tirada.

**Comprobado antes de lanzar**: por defecto, idéntico a la referencia a
número fijo de generaciones (`prereg2_abc_300s`, `ref_I-018`, `ref_I-021`);
11256 llamadas dobles por tirada en ta23 y 29276 en ta45, de las que mejoran
el **12 y el 17 %**; a cambio, **un tercio menos de generaciones** (61 → 40,
154 → 98). Horarios factibles.
...
### I-039 — JOX con probabilidad de conservar uniforme

**De dónde sale**: I-036 cambió JOX por una interpolación determinista y
perdió **25 unidades**; lo más probable es que la **variedad** de los cruces
de JOX importe mucho. Esta idea hace la pregunta contraria: ¿ayuda **más**
variedad? Hoy JOX conserva cada trabajo del primer padre con probabilidad
**1/2** fija, así que los hijos caen siempre a media distancia de los padres.

**La idea**: `crossover.jox.mask = uniform`. En cada cruce la probabilidad de
conservar se sortea en U(0,1): unos hijos caen cerca de un padre, otros del
otro, otros en medio, **con la misma media**. Sin constante que ajustar. Por
defecto no se sortea nada más y la comparación es exactamente la de antes.

**Comprobado antes de lanzar**: por defecto, idéntico a la referencia a
número fijo de generaciones; probabilidad media conservada 0.499 y
desviación media respecto de 1/2 de 0.251, lo que da una uniforme; y las
generaciones **suben** mucho (64 → 92 en ta23, 152 → 284 en ta45), porque un
hijo cerca de un padre está casi en un óptimo local y su cadena acaba antes.
Horarios factibles.

**Filtro**: descartar si `umask − control` supera +2.0, semillas 1001 a 1030.
**Endpoint**: media por instancia, Pocock simétrica p <= 0.0142. **Mecanismo,
primero**: cruces con máscara sorteada, probabilidad media y su desviación,
generaciones.

### I-039, filtro: descartada y revertida

240 trabajos, cero infactibles, semillas 1001 a 1030, control en `ref_I-021`.
**Mecanismo, ejercido**: unos 37400 cruces por tirada con la probabilidad
sorteada, media 0.50 y desviación media 0.25, como una uniforme; y las
generaciones **suben** mucho: 72 → 111 (ta23), 90 → 112 (ta29), 73 → 102
(ta30), 191 → 292 (ta45). Media por instancia `umask − control`: ta23
+13.20, ta29 +6.27, ta30 +8.70, ta45 +18.63, **+11.70**; regla *descartar si
> +2.0*: **descarta**, en las cuatro.

**Lo que dice, junto con I-036**: los dos cruces que **suben las
generaciones** son los que **hunden** el resultado. Un hijo cerca de uno de
sus padres está casi en el óptimo local de ese padre: la cadena acaba enseguida
y vuelve donde ya se estaba. La máscara de 1/2 de JOX es la que pone al hijo
**lo más lejos posible de los dos padres** a la vez, y eso es lo que alimenta a
la cadena profunda con sitios nuevos. Las generaciones altas aquí no son
velocidad, son **síntoma de cadenas cortas**. Queda como regla de lectura:
una idea que sube mucho las generaciones sin haber acelerado nada está, casi
seguro, dando a la búsqueda local puntos que ya conoce.
...
240 trabajos, cero infactibles, semillas 1001 a 1030, control en `ref_I-021`.
**Mecanismo, ejercido**: unas 12500 cadenas cortadas por tirada, del 27 al 44
% de las comprobadas (6985 de 26322 en ta29, 11953 de 28265 en ta23). Las
**llamadas al tabú quedan iguales** (53631 → 53254 en ta23, 144553 → 146758
en ta45) y las **generaciones suben** (74 → 114, 90 → 107, 74 → 101, 188 →
266): el tiempo que se ahorra en las cadenas perdidas se gasta en cadenas
nuevas, que es exactamente lo que la idea quería. Media por instancia
`cut − control`: ta23 −2.03, ta29 −1.97, ta30 +3.20, ta45 +1.00, **+0.05**;
regla *descartar si > +2.0*: **pasa**. Dividida: mejor en las dos de 20x20
más difíciles de mover, peor en ta30. Van las oleadas.

### I-040, cierre: cortar las cadenas perdidas es neutro, rechazada y revertida

Filtro y seis oleadas, 1500 tiradas, cero infactibles, control en `ref_I-021`.
Media por instancia `cut − control`: filtro +0.05, mirillas −0.18, **−1.78
(p = 0.037)**, −1.28 (p = 0.042), −0.65, −0.37, **−0.20**, con p final
**0.651** y mejor en 12 de 21. **No cruza.** La señal de las mirillas 2 y 3
era ruido que volvió a la media: es exactamente el caso para el que existe la
frontera de Pocock, y conviene decirlo porque a la mitad parecía la mejor
idea desde I-021.

**Lo que dice**: el mecanismo funcionó como se diseñó (en torno a un tercio de
las cadenas cortadas, las llamadas al tabú iguales, las generaciones arriba
un 16-55 %), y aun así el resultado no se mueve. Reasignar el tiempo de las
cadenas perdidas a cadenas nuevas **no gana ni pierde**: lo que se deja de
encontrar en el 10 % de mejoras cortadas lo compensan, sin más, las cadenas
nuevas. Con I-020 (quitar la segunda llamada a todas pierde) e I-037 (más
profundidad pierde), el reparto actual del tabú en la fase de empleadas está
**en su punto**: ni más hondo, ni más corto, ni reasignado.
...
### I-041, filtro: pasa por poco, y en contra

240 trabajos, cero infactibles, semillas 1001 a 1030. **Mecanismo,
ejercido**: unos 4000 movimientos laterales por tirada (2458 en ta23, 5576 en
ta29); exploradores y generaciones en el orden del control (81 → 82, 97 → 95,
78 → 81, 193 → 202). Media por instancia `side − control`: ta23 +3.33, ta29
...
### I-043 — híbrido ABC → CP-SAT sobre los 20 mejores horarios de `ta23`

**De dónde sale**: I-042 mostró que CP-SAT no mejora **el** mejor horario de
cada instancia en 600 s. Pero el ABC no deja uno, deja muchos óptimos locales
**distintos** a pocas unidades del mejor; la caza de I-032 tiene 800 tiradas
de `ta23`. La pregunta es si CP-SAT, como pulidor, mueve **alguno** de ellos:
si el cuello es la región y no el resolvedor, repartir el tiempo entre
regiones distintas debería rendir más que gastarlo entero en una.

**El sondeo**: los **20** horarios distintos de makespan más bajo de
`ta23` en los resultados de I-032 (`iter/I-043/top_schedules.py`), cada uno
como pista completa de CP-SAT con el mismo modelo y ajustes de I-042 (14
hilos, semilla 1), **60 s** por pista, 20 minutos en total. **Fijado antes de
correr**: 20 pistas, 60 s. Todo horario mejor que su pista se escribe como
certificado y se comprueba con `verify_certificate.py`.

**Lectura**: cuántas pistas mejora, cuánto y el mejor makespan alcanzado,
contra 1561 (nuestro mejor) y 1557 (el mejor conocido).

### I-043, cierre: el híbrido iguala `ta23`, desde una pista de 1566

20 pistas, 60 s cada una, 14 hilos, semilla 1, máquina vacía
(`iter/I-043/probe_run.log`, certificados en `iter/I-043/found_*`).

| pista | makespan | tras CP-SAT |
|---|---|---|
| 1 | 1561 | 1561 |
| 2 | 1563 | 1563 |
| 3 | 1564 | 1564 |
| 4 | 1565 | 1565 |
| 5 | 1566 | 1565 |
| **6** | **1566** | **1557** (1564, 1563, 1562 en el primer segundo; 1559 a los 30 s, 1558 a los 37.5 s, **1557 a los 39.6 s**) |
| 7 | 1566 | 1564 |
| 8-12 | 1567 | 1567 |
| 13, 14, 18 | 1567 | 1565 |
| 17 | 1567 | 1564 |
...
**Igualada de `ta23`, 1557**, la primera de la línea: `verify_certificate.py`
contra los datos originales de la OR-Library dice *"best verified makespan
1557 -- matches the best known solution 1557"*
(`iter/I-043/found_hint6_found_ta23_1557_Certificate.csv`). Hasta ahora
nuestro mejor en `ta23` era 1561, tras 800 tiradas de caza (I-032).

**Lo que dice, y es lo más importante de la línea desde I-021**:

1. **El mejor horario del ABC no es la mejor pista.** Las cuatro pistas más
   bajas (1561 a 1565) no se mueven, como en I-042; una de 1566 baja nueve
   unidades. La calidad de la pista no predice cuánto la mejora CP-SAT, igual
   que la calidad en bruto de un hijo no predecía su óptimo (I-035).
2. **El reparto entre regiones rinde**: 9 de 20 pistas mejoran con 60 s cada
   una, mientras 600 s sobre la mejor no hicieron nada. El cuello era la
   región, y el ABC la aporta: produce muchos óptimos distintos cerca del
   mejor, que es exactamente lo que CP-SAT necesita como punto de partida.
3. **La pista 6 seguía bajando** cuando se acabaron los 60 s (1559, 1558,
   1557 en diez segundos). No se sabe dónde se habría parado.

**Siguiente paso, fijado ahora**: I-044, el mismo híbrido donde un récord
está a una unidad (`ta29`, `ta30`), y la continuación de la pista 6.

### I-044 — el híbrido ABC → CP-SAT en `ta29`, `ta30` y la continuación de `ta23`

**Fijado antes de correr** (`iter/I-044/run_probe.sh`), mismo modelo y
ajustes que I-042 (14 hilos, semilla 1), máquina vacía, unos 31 minutos:

1. `ta23`: **600 s** desde el horario de 1557 de I-043, que seguía bajando
   cuando se le acabó el tiempo. Por debajo de 1557 es récord.
2. `ta29`: sus **10** horarios distintos de makespan más bajo entre todos los
   resultados de la línea, **60 s** cada uno. Récord por debajo de 1625.
3. `ta30`: lo mismo. Récord por debajo de 1584.
...
### I-045 — el híbrido ABC → CP-SAT en `ta22`, `ta25`, `ta26` y `ta27`

**De dónde sale**: I-044 dice que en `ta29` y `ta30` el híbrido ya no tiene
recorrido (1625 y 1584 se comportan como suelos). En `ta23` sí lo tuvo, desde
4 unidades por encima del BKS. Las otras cuatro 20x20 abiertas están más
lejos: nuestros mejores horarios son **1613** en `ta22` (BKS 1600), **1616**
en `ta25` (1595), **1660** en `ta26` (1643) y **1694** en `ta27` (1680).

**Fijado antes de correr** (`iter/I-045/run_probe.sh`): los **6** horarios
distintos más bajos de cada instancia entre todos los resultados de la línea,
**75 s** de CP-SAT cada uno (modelo y ajustes de I-042), unos 30 minutos.
Todo horario mejor que su pista se verifica contra la OR-Library.

**Lectura**: cuánto baja el mejor de cada instancia, y si alguna llega al
mejor conocido o por debajo.

### I-045, cierre: tres mejores propios, y las mejoras llegan pronto

`iter/I-045/probe_run.log`; todos los horarios nuevos verificados contra la
OR-Library.

| instancia | mejor antes | mejor ahora | BKS | desde qué pista |
|---|---|---|---|---|
| ta22 | 1613 | 1613 | 1600 | las seis pistas son 1613 y ninguna se mueve |
| ta25 | 1616 | **1603** | 1595 | pista 5, de **1617**: nueve mejoras, la última a los 7.6 s |
| ta26 | 1660 | **1653** | 1643 | pista 2, de **1661**, a los 36.4 s |
| ta27 | 1694 | **1689** | 1680 | pista 5, de **1696**, a los 60.8 s; cinco pistas más llegan a 1691 |

**Lo que dice**: (1) se repite I-043: **la mejor pista no es la que más
baja** (en `ta25` la de 1616 se queda en 1613 y una de 1617 llega a 1603); (2)
casi todas las mejoras llegan en los **primeros 10 a 40 s** y después CP-SAT
...
### I-046, cierre: muchas pistas mejoran casi todas, y `ta27` baja a 1685

`iter/I-046/probe_run.log`; ningún horario infactible.

- **`ta25`**: **34 de 40** pistas mejoran en 20 s (de 1616-1627 a 1603-1616),
  pero el mejor vuelve a ser **1603**, el mismo valor que en I-045.
- **`ta27`**: **31 de 40** mejoran; el mejor es **1685**, **nuevo mejor
  propio** (antes 1689; BKS 1680), y nueve pistas acaban en 1691.

**Lo que dice**: con 20 s casi todas las pistas bajan, lo que confirma que el
tiempo corto basta; pero el mínimo de cada instancia se estanca en un valor
(1603 en `ta25`) que ni más pistas ni más tiempo mueven. El híbrido lleva
cada pista a su fondo local de CP-SAT, y esos fondos tienen un mínimo propio
por encima del BKS. Para bajar más haría falta **pistas de otras regiones**,
no más CP-SAT sobre las mismas: la pregunta siguiente es si el ABC, sembrado
con los horarios que CP-SAT deja, produce pistas nuevas mejores.

### I-047 — cerrar el ciclo: ABC sembrado con CP-SAT, y CP-SAT otra vez

**De dónde sale**: I-046 dice que cada pista baja hasta su fondo de CP-SAT y
que el mínimo de esos fondos se estanca (1603 en `ta25`). Hacen falta pistas
**nuevas**, cerca de lo mejor pero distintas; eso es lo que el ABC fabrica.
La siembra ya existe en el árbol (`CreationJSP_Seeded`, de I-001).

**Fijado antes de correr** (`iter/I-047/run.sh`):

1. **Pool**: todos los horarios distintos que CP-SAT dejó en I-045 e I-046,
   ordenados por makespan y escritos como secuencia de trabajos
   (`make_pool.py`): **143** en `ta25` (1603 a 1626) y **99** en `ta27` (1685
   a 1702). Comprobado: la generación 0 de una tirada sembrada arranca
   exactamente en 1603 y 1685.
2. **ABC**: `ref_I-021` con `creation = jsp.seeded`, 25 semillas de 247, la
   tirada `p` toma líneas desde el desplazamiento `p`; **28 tiradas por
   instancia**, semillas 7101 a 7128, 40 s cada una (el presupuesto de su
   clase), por la cola de siempre.
3. **CP-SAT**: los **20** horarios distintos más bajos de esas tiradas, 20 s
   cada uno (modelo y ajustes de I-042).

**Lectura**: el mejor del ABC sembrado frente a su punto de partida (1603,
1685), y el mejor tras CP-SAT, frente al BKS (1595, 1680).

### I-047, cierre: el ciclo no encuentra nada nuevo alrededor de los fondos

`iter/I-047/run.log`. 56 tiradas sembradas de 40 s, cero infactibles. El
**ABC sembrado no baja de su mejor semilla** en ninguna: las mejores tiradas
devuelven exactamente 1603 (`ta25`, tres tiradas) y 1685 (`ta27`, dos), y el
resto se queda en 1604-1618 y 1689-1691. **CP-SAT** sobre los mejores
horarios distintos de esas tiradas (20 en `ta25`, 13 en `ta27`, que no daban
para más) tampoco pasa de **1603** ni de **1685**; varias pistas de 1611-1618
bajan a 1608-1610, sin acercarse.

**Lo que dice**: 1603 y 1685 son **fondos compartidos** por los dos métodos:
el ABC arrancando en ellos no sale, y CP-SAT sobre lo que el ABC produce
alrededor vuelve a ellos. El ciclo ABC ↔ CP-SAT, tal como está, converge a
esos puntos. Queda como mejores propios verificados: `ta23` **1557 (= BKS)**,
`ta25` **1603**, `ta26` **1653**, `ta27` **1685**.

### I-048 — el híbrido ABC → CP-SAT en las 30x15 abiertas

**De dónde sale**: en las 20x20 el híbrido ha llegado a fondos compartidos
(I-047). En las 30x15 abiertas nuestros mejores horarios quedan más lejos:
`ta32` **1815** (LB 1774, BKS 1784), `ta33` **1820** (1788, 1791), `ta34`
**1843** (1828, 1829), `ta40` **1695** (1651, 1669). En `ta33` y `ta34` la cota
inferior está pegada al mejor conocido: un 1828 en `ta34` sería récord **y**
óptimo demostrado.

**Fijado antes de correr** (`iter/I-048/run_probe.sh`): los **6** horarios
distintos más bajos de cada instancia, **60 s** de CP-SAT cada uno (modelo y
ajustes de I-042), unos 24 minutos, verificación de todo horario nuevo.

### I-048, cierre: cuatro mejores propios en las 30x15

`iter/I-048/probe_run.log`, cero infactibles, todo verificado.

| instancia | mejor antes | mejor ahora | BKS | LB |
|---|---|---|---|---|
| ta32 | 1815 | **1811** | 1784 | 1774 |
| ta33 | 1820 | **1802** | 1791 | 1788 |
| ta34 | 1843 | **1834** | 1829 | 1828 |
| ta40 | 1695 | **1688** | 1669 | 1651 |

En `ta34` cinco de seis pistas acaban exactamente en **1834**, desde 1843 a
1847: otro fondo compartido. En `ta33` la mejora grande (−18) viene de la
mejor pista, al revés que en las 20x20. Siguiente paso: la variante de
muchas pistas (I-046) en `ta33` y `ta34`, las dos más cerca de su BKS.

### I-049 — muchas pistas en `ta33` y `ta34`

**Fijado antes de correr** (`iter/I-049/run_probe.sh`, copia de I-046 con las
...
### I-050 — continuaciones largas en 30x15

**Fijado antes de correr** (`iter/I-050/run_probe.sh`): CP-SAT desde el
horario más bajo que dejó I-048 en cada instancia, **600 s** en `ta33` (1802)
...
### I-051, cierre: cuatro mejores propios en 30x20, pequeños

`iter/I-051/probe_run.log`, 52 horarios nuevos verificados, cero infactibles.
`ta45` 2015 → **2011** (BKS 2000), `ta49` 1987 → **1980** (1961, desde una
pista de 1993), `ta44` 2011 → **2009** (1979, desde una de 2020), `ta42` 1974
→ **1971** (1937). Mejoras de 2 a 7 unidades frente a huecos de 11 a 34: en
30x20, 60 s de CP-SAT por pista es poco para una instancia de 600
operaciones, y los horarios del ABC están más lejos del BKS que en 20x20.

### I-052 — la aleatoriedad de CP-SAT sobre las pistas que mejor rindieron

**De dónde sale**: todo lo hecho con CP-SAT usa la semilla 1. Las pistas que
dieron los mejores propios de 20x20 aún por encima del BKS son **intermedias**
(la de `ta27` era la 31.ª, de 1702), y cada una bajó por una trayectoria
concreta de CP-SAT. Con otra semilla, la misma pista puede caer en otro fondo.

**Fijado antes de correr** (`iter/I-052/run_probe.sh`; `cpsat_probe.py`
admite ahora la semilla como quinto argumento, por defecto 1): `ta25` desde la
pista de 1617 que llegó a 1603 (I-045), `ta26` desde la de 1661 que llegó a
1653 (I-045), `ta27` desde la de 1702 que llegó a 1685 (I-046); **semillas 2 a
13, 45 s cada una**, unos 27 minutos.

### I-052, cierre: los fondos son de la pista, no de la semilla

`iter/I-052/probe_run.log`. Con las semillas 2 a 13 y 45 s, cada pista cae
**siempre en los mismos dos o tres fondos**: la de `ta25` en **1603** diez
veces de doce (y 1615, 1616); la de `ta26` en 1653 tres veces y 1660 nueve;
la de `ta27` en **1685** ocho veces y 1689 cuatro. Ninguna baja de su mejor.

**Lo que dice**: el fondo al que CP-SAT lleva una pista es casi una
**propiedad de la pista**; la aleatoriedad del resolvedor solo elige entre unos
pocos. Para bajar el mínimo hay que cambiar de pista, no de semilla, lo que
deja una sola palanca en el híbrido: **más pistas distintas**, y en I-046 la
mejor de `ta27` salió de la 31.ª.

### I-053 — más abajo en la lista de pistas de `ta25`

**Fijado antes de correr** (`iter/I-053/run_probe.sh`): los horarios
distintos y factibles de `ta25` en los puestos **41 a 120** por makespan (los
...
### I-054, cierre: ninguna mezcla de dos fondos mejora el atractor, y está demostrado

`iter/I-054/run.log`, un minuto en total. Las **30** recombinaciones (15 en
`ta25`, 15 en `ta27`) terminan con estado **OPTIMAL** en 0 a 2 s, y el óptimo
del subespacio es siempre el mejor padre: **1603** y **1685**. Los padres, que
son los fondos de pistas distintas, coinciden en el **86.6 a 96.8 %** de los
3800 pares de máquina en `ta25` y en el 93.3 a 95.8 % en `ta27`: quedan libres
entre 123 y 510 pares, y en ese espacio no hay nada mejor.

**Lo que dice**: los fondos de CP-SAT, aunque vengan de pistas distintas,
comparten nueve de cada diez decisiones de máquina con el atractor, y
**ninguna mezcla de dos de ellos lo mejora**; no es una impresión, es un
óptimo demostrado en cada subespacio. Siguiente paso, fijado ahora: fijar
solo lo que comparten **todos** los padres de un grupo, con grupos cada vez
más grandes, para ver hasta dónde llega esa demostración.

### I-055 — recombinación por consenso de grupos de fondos

**Fijado antes de correr** (`iter/I-055/run.sh`, `consensus.py`): los fondos
por pista de I-054, del más bajo al más alto; para cada K de una serie
anidada (`ta25`: 4, 8, 16, 32, 64, 107; `ta27`: 4, 8, 16, 37) se fijan solo
los pares de máquina que **los K** ordenan igual, el resto libre, y CP-SAT
minimiza **120 s** con la mejor del grupo como pista. Se anota cuántos pares
...
### I-056, cierre: 1603 es óptimo en el consenso de los 107 fondos

`iter/I-056/run.log`. Con 600 s, los dos consensos que I-055 no cerró cierran:
K = 64 (1133 pares libres) **OPTIMAL 1603** en 163 s, y K = **107** (1263
libres, un tercio de los 3800) **OPTIMAL 1603** en 565 s. **Todo horario de
`ta25` mejor que 1603 rompe al menos una de las 2537 decisiones de máquina
que comparten los 107 fondos.**

### I-057 — romper el núcleo de `ta25` máquina a máquina

**Fijado antes de correr** (`iter/I-057/run.sh`, `break_machine.py`): el
consenso de los 107 fondos, con los pares de consenso de **una** máquina
liberados además de los 1263 ya libres; una vez por cada una de las 20
máquinas, **60 s** de CP-SAT cada una. Si la mejora está en romper decisiones
de una sola máquina, aparece; si no, cada máquina queda cerrada u acotada.

### I-057, cierre: no concluyente

`iter/I-057/run.log`. Liberando además los pares de consenso de una máquina
(entre 1361 y 1406 pares libres), CP-SAT **no encuentra nada mejor que 1603**
en ninguna de las 20 máquinas, pero **tampoco cierra ninguna** en 60 s: las
cotas quedan entre 1584 y 1588. El consenso de los 107 fondos, con 1263
libres, necesitó 565 s para cerrar (I-056); 60 s no bastan con 100-140 pares
...
### I-058, cierre: 1613 en `ta22` es el atractor más marcado

`iter/I-058/probe_run.log`, cero infactibles. En `ta22`, **38 de las 40
...
### I-062 — buscar contra el núcleo en `ta22`

**De dónde sale**: I-061 demuestra que ningún horario de `ta22` con makespan
≤ 1606 respeta el núcleo de 2953 decisiones; si nuestro 1613 se puede batir,
el horario mejor está fuera. En vez de minimizar dentro, se pide a CP-SAT un
horario **fuera**: cada par del núcleo lleva una variable booleana que dice si
se respeta, y se exige que **al menos D** se inviertan, con makespan **≤ 1612**
(`iter/I-062/anticore.py`).

**Fijado antes de correr** (`iter/I-062/run.sh`): el núcleo de 30 horarios de
I-060/I-061; **D = 10, 50 y 150**; **480 s** de CP-SAT cada uno, sin pista (el
1613 no cumple el tope). La prueba de humo de 20 s con D = 10 construye el
modelo y no encuentra nada en ese tiempo.

### I-062, cierre: no concluyente

`iter/I-062/run.log`. Con D = 10, 50 y 150 y 480 s cada uno, CP-SAT **no
encuentra** ningún horario de makespan ≤ 1612 que invierta esas decisiones del
núcleo, y **tampoco demuestra** que no exista (UNKNOWN en los tres). Sin pista
que cumpla el tope, pedir un horario de `ta22` bajo 1613 es tan difícil como
resolver la instancia casi óptimamente desde cero, y CP-SAT en frío llegaba a
1629 en 120 s (I-059). Buscar contra el núcleo necesita un punto de partida
fuera de él; ninguno de nuestros generadores lo da.

### Estado de la línea tras I-062 (2026-09-25)

- **Mejores propios verificados**: `ta23` **1557 = BKS**; `ta29` 1625 y `ta30`
  1584, BKS igualados; `ta25` 1603, `ta26` 1653, `ta27` 1685, `ta22` 1613,
  `ta32` 1809, `ta33` 1802, `ta34` 1834, `ta40` 1686, `ta42` 1971, `ta44`
  2009, `ta45` 2011, `ta49` 1980. **Ningún récord.**
- **Lo demostrado**: en `ta22`, `ta25` y `ta27`, el BKS está fuera del núcleo
  de decisiones de máquina que comparten todos nuestros buenos horarios (y, en
  `ta22`, también los de CP-SAT en frío). Todo lo que hacemos trabaja dentro de
  él.
- **Lo que falta para seguir con sentido**: un punto de partida **fuera** del
  núcleo. El más informativo serían los propios horarios BKS publicados, que
  dirían qué decisiones del núcleo rompen; descargarlos requiere el permiso
  del PI.

### I-063 — el híbrido en las 30x20 sin pulir

**Fijado antes de correr** (`iter/I-063/run_probe.sh`, copia de I-051): `ta41`
(mejor propio 2059, BKS 2005), `ta43` (1890, 1846), `ta46` (2043, 2004), `ta47`
(1926, 1889), `ta48` (1996, 1937); los 6 horarios distintos y factibles más
bajos, 60 s de CP-SAT cada uno, unos 30 minutos. No es un intento de récord
(los huecos son de 37 a 59); completa el mapa de mejores propios mientras el
PI decide sobre los horarios BKS.

### I-063, cierre: cinco mejores propios en 30x20

`iter/I-063/probe_run.log`, cero infactibles, todo verificado. `ta41` 2059 →
...
### I-064, cierre: `ta18` a 1405, `ta50` a 1950

`iter/I-064/probe_run.log`, cero infactibles, todo verificado. `ta18`: 10 de
20 pistas mejoran, el mejor pasa de 1414 a **1405** (BKS 1396), alcanzado por
dos pistas distintas; `ta50`: 5 de 6, de 1966 a **1950** (1923).

### I-065 — muchas pistas en `ta18`

**Fijado antes de correr** (`iter/I-065/run_probe.sh`): las pistas **21.ª a
80.ª** de `ta18` (distintas y factibles, por makespan), **20 s** de CP-SAT
cada una, unos 21 minutos. `ta18` es la más pequeña de las abiertas (300
operaciones) y la que tiene el hueco más corto tras I-064 (9 unidades).

### I-065, cierre: sin mejor nuevo en `ta18`

`iter/I-065/probe_run.log`, cero infactibles. Las pistas 21.ª a 80.ª de `ta18`
son todas de 1420; 16 de 60 mejoran, el mejor llega a 1409. El mejor propio
sigue en 1405 (I-064).

### I-066 — el núcleo de `ta18` y de `ta26`

**Fijado antes de correr** (`iter/I-066/run.sh`, `floors.py`): el fondo por
pista de CP-SAT (el certificado más bajo de cada pista) de I-064/I-065 en
`ta18` y de I-045/I-058 en `ta26`, más el mejor horario factible guardado de
...
### I-067, cierre: bajar de 1405 en `ta18` exige romper al menos dos máquinas

`iter/I-067/run.log`. Liberando los pares de consenso de cada máquina (775 a
807 pares libres), **las 15 cierran OPTIMAL en 1405**, entre 13 y 31 s. Queda
**demostrado** que todo horario de `ta18` con makespan menor que 1405 (el BKS
1396 incluido) rompe decisiones del núcleo en **dos máquinas o más**.

### I-068 a I-070 — romper el núcleo de `ta18` por parejas de máquinas

**Fijado antes de correr** (`iter/I-068/run.sh`, `break_machines.py`): el mismo
consenso con los pares de **dos** máquinas liberados; las **105** parejas en
orden lexicográfico, en tres tandas de 35 (I-068: 1-35, I-069: 36-70, I-070:
...
### I-069, cierre: 27 parejas cierran, 8 quedan abiertas

`iter/I-068/run_batch2.log`. De las parejas 36 a 70, **27 cierran OPTIMAL en
1405** y **8 no cierran** en 45 s: (3,5), (3,8), (3,13), (4,5), (4,8), (4,13),
...
### I-071, cierre: primera salida del núcleo, `ta18` a 1404

`iter/I-071/run.log`. Con 120 s las 12 parejas abiertas cierran todas
OPTIMAL: once en 1405 y **la pareja (5, 8) en 1404**
(`iter/I-071/found_m5-8_ta18_1404_Certificate.csv`), que `verify_certificate.py`
confirma contra la OR-Library: *"best verified makespan 1404"*. Es un **nuevo
mejor propio de `ta18`** (antes 1405) y el **primer horario que sale del
núcleo** de toda la línea: rompe decisiones comunes a los 27 horarios en las
máquinas 5 y 8 a la vez.

**El mapa completo de parejas**: de las 105, **104 tienen óptimo 1405** y
**solo (5, 8) permite bajar**, a 1404. Todo lo que está por debajo de 1404
(el BKS 1396 incluido) rompe el núcleo en **más de dos máquinas**, o en dos
máquinas partiendo de un núcleo que ya no es este.

**Lo que abre**: un método de descenso. Romper el núcleo, encontrar un horario
mejor fuera de él, **recalcular el núcleo con ese horario y repetir**. I-072 es
la primera vuelta.

### I-072 — primera vuelta del descenso por ruptura del núcleo en `ta18`

**Fijado antes de correr** (`iter/I-072/run.sh`): el grupo de I-066 **más el
horario de 1404**, que pasa a ser el mejor del grupo y la pista; con él el
...
### I-074, cierre: 1401 aguanta las máquinas sueltas y 34 de 35 parejas

`iter/I-074/run_singles.log`, `run_1.log`. Con el 1401 en el grupo (29
horarios), **las 15 máquinas sueltas cierran OPTIMAL en 1401** y de las parejas
1 a 35 cierran **34**; queda abierta (0,13) cota 1398, sin mejora. El núcleo con el 1401
cierra más deprisa que con el 1404. Sigue la tanda 2 (I-075).

### I-074 a I-076, vuelta 3 desde 1401: 98 de 105 parejas demostradas

Con el 1401 en el grupo: las 15 máquinas sueltas y **98 de las 105 parejas**
cierran OPTIMAL en 1401; quedan abiertas (0,13), (3,13), (6,13), (7,8), (7,12),
(7,13) y (10,13), con cotas de 1396 a 1399 y sin mejora. La máquina 13 está en
cinco de las siete, como en las vueltas anteriores. I-077 las repite con 180 s.

### I-077, cierre: 1401 aguanta todas las máquinas y todas las parejas

`iter/I-077/run.log`. Con 180 s las siete parejas abiertas cierran **OPTIMAL
en 1401** (34 a 59 s). La vuelta 3 queda completa: con el núcleo de los 29
horarios, **1401 es óptimo liberando cualquier máquina suelta o cualquiera de
las 105 parejas**. Bajar de 1401 exige romper el núcleo en **tres máquinas o
más**.

### I-078 — vuelta 4 del descenso: tríos de máquinas

**Fijado antes de correr** (`iter/I-078/run.sh`, `sets.txt`): de los 455
...
### I-079, cierre: 18 de 20 máquinas de `ta27` en 1685

`iter/I-079/run.log`. Liberando cada máquina, **18 de 20 cierran OPTIMAL en
1685**; la **0** (cota 1683) y la **15** (cota **1679**, por debajo del BKS)
no cierran en 60 s. Ninguna mejora.

### I-080 — `ta27`: las máquinas abiertas y sus parejas

**Fijado antes de correr** (`iter/I-080/run.sh`): las máquinas 0 y 15 con
**180 s**; después las **37 parejas** que contienen la 0 o la 15, **40 s**
cada una. En `ta18` las dos mejoras salieron de parejas que costaba cerrar;
aquí se empieza por las más prometedoras en vez de recorrer las 190.

### I-080, cierre: las 20 máquinas de `ta27` en 1685; las parejas no cierran

`iter/I-080/run.log`. Con 180 s, las máquinas **0 y 15 cierran OPTIMAL en
1685**: las 20 máquinas de `ta27` quedan demostradas. Las **37 parejas** que
las contienen **no cierran** en 40 s (cotas 1673 a 1682) y ninguna mejora:
`ta27` (400 operaciones, 20 máquinas) es mucho más dura que `ta18`. Las
cotas más bajas, **(15,17) 1673** y **(0,15), (0,17) 1676**, están **por
debajo del BKS**: esos subespacios podrían contener horarios de 1680 o menos.

### I-081 — las tres parejas de cota más baja de `ta27`

**Fijado antes de correr** (`iter/I-081/run.sh`): (15,17), (0,15) y (0,17),
**400 s** cada una, el grupo de I-079.

### I-081, cierre: las parejas de `ta27` cierran con tiempo

`iter/I-081/run.log`. Las tres parejas de cota más baja, (15,17), (0,15) y
(0,17), cierran **OPTIMAL en 1685** en 77, 83 y 92 s. Las cotas por debajo del
BKS eran falta de tiempo, no horarios mejores.

### I-082 — campaña de parejas de máquinas en `ta27`

**Fijado antes de correr** (`iter/I-082/batch.sh`, `pairs.txt`): las **187**
parejas que quedan (las 190 menos las tres de I-081), **90 s** cada una, el
...
- I-082, parejas 41-60: 20 cerradas OPTIMAL en 1685; ninguna mejora.

- I-082, parejas 61-80: 19 cerradas OPTIMAL en 1685; abiertas: (3,15) 1681; ninguna mejora.

- I-082, parejas 81-100: 19 cerradas OPTIMAL en 1685; abiertas: (5,15) 1679; ninguna mejora.

- I-082, parejas 101-120: 20 cerradas OPTIMAL en 1685; ninguna mejora.

- I-082, parejas 121-140: 20 cerradas OPTIMAL en 1685; ninguna mejora.

- I-082, parejas 141-160: 20 cerradas OPTIMAL en 1685; ninguna mejora.
...
### I-083, cierre: 18 de 20 máquinas en 1684

`iter/I-083/run.log`. Con el 1684 en el grupo (38 horarios), **18 máquinas
cierran OPTIMAL en 1684**; la **15** (cota 1683) y la **17** (cota 1680) no
cierran en 60 s. Ninguna mejora.

### I-084 — `ta27` vuelta 2: las máquinas abiertas y sus parejas
...
### I-084, cierre: `ta27` iguala el BKS, 1680

`iter/I-084/run_*.log`. En la segunda tanda, **la pareja (15, 18) cierra
OPTIMAL en 1680** (`iter/I-084/found_m15-18_ta27_1680_Certificate.csv`), en
37 s; `verify_certificate.py` contra los datos originales de la OR-Library:
*"best verified makespan 1680 -- matches the best known solution 1680"*.
**Igualada de `ta27`**, la segunda de la línea tras `ta23` y la primera del
descenso por ruptura del núcleo: **1685 → 1684 → 1680**. El resto de la vuelta:
las máquinas 15 y 17 y 35 parejas cierran en 1684, (15,17) queda abierta.

### I-085 — vuelta 3 del descenso en `ta27`, desde el BKS

**Fijado antes de correr** (`iter/I-085/run.sh`): el grupo de I-083 más el
1680; las 20 máquinas sueltas, 60 s cada una. **Todo horario por debajo de
1680 sería récord** y se verifica igual que los demás.

### I-085, cierre, e I-086: intento de récord en `ta27`

`iter/I-085/run.log`. Con el 1680 en el grupo (39 horarios), **las 20
máquinas cierran OPTIMAL en 1680**. **I-086**, fijado antes de correr
(`iter/I-086/batch.sh`, `pairs.txt`): las **190 parejas** de máquinas, **90 s**
...
- I-086, parejas 41-60: 20 cerradas OPTIMAL en 1680; ninguna mejora.

- I-086, parejas 61-80: 20 cerradas OPTIMAL en 1680; ninguna mejora.

- I-086, parejas 81-100: 20 cerradas OPTIMAL en 1680; ninguna mejora.

- I-086, parejas 101-120: 20 cerradas OPTIMAL en 1680; ninguna mejora.

- I-086, parejas 121-140: 20 cerradas OPTIMAL en 1680; ninguna mejora.

- I-086, parejas 141-160: 20 cerradas OPTIMAL en 1680; ninguna mejora.

- I-086, parejas 161-190: 30 cerradas OPTIMAL en 1680; ninguna mejora.

### I-086, cierre: 1680 aguanta las 190 parejas de `ta27`

`iter/I-086/run_*.log`. Desde el grupo del 1680, **las 190 parejas de máquinas
cierran OPTIMAL en 1680**. Con I-085 (las 20 máquinas sueltas), queda
**demostrado** que todo horario de `ta27` por debajo de 1680, es decir todo
récord, rompe el núcleo de esos 39 horarios en **tres máquinas o más**.

### I-087 — `ta27` desde 1680: tríos de máquinas
...
### I-088, cierre: `ta25` no baja con el núcleo de 8 fondos

`iter/I-088/run_*.log`. Con el consenso de los 8 fondos más bajos, **las 20
máquinas y las 190 parejas cierran OPTIMAL en 1603**, cada una en 4 s como
mucho. Pero ese núcleo **fija más** pares (81.9 %) que el de 107 fondos
(66.8 %), así que el espacio explorado es menor que en `ta18` o `ta27` (grupos
de 27-39): la demostración es más débil. Con un núcleo más ancho, cada pareja
costaría minutos y el recorrido superaría las quince horas.

### I-089 — todos los tríos de máquinas de `ta18`

**Fijado antes de correr** (`iter/I-089/batch.sh`, `sets.txt`): desde el grupo
del 1401, los **425** tríos que no probó I-078, **50 s** cada uno, en tandas de
...
- I-089, tríos 71-105: 32 cerradas OPTIMAL en 1401; abiertas: (0,10,13) 1396,(0,12,13) 1398,(1,3,8) 1397; ninguna mejora.

- I-089, tríos 106-140: 33 cerradas OPTIMAL en 1401; abiertas: (1,7,8) 1397,(1,7,13) 1397; ninguna mejora.

- I-089, tríos 141-175: 31 cerradas OPTIMAL en 1401; abiertas: (1,8,13) 1398,(1,13,14) 1398,(2,3,8) 1399,(2,3,13) 1398; ninguna mejora.

- I-089, tríos 176-210: 33 cerradas OPTIMAL en 1401; abiertas: (2,7,8) 1398,(2,7,13) 1395; ninguna mejora.

- I-089, tríos 211-245: 31 cerradas OPTIMAL en 1401; abiertas: (2,10,13) 1397,(3,4,8) 1397,(3,6,7) 1399,(3,6,13) 1396; ninguna mejora.

- I-089, tríos 246-280: 25 cerradas OPTIMAL en 1401; abiertas: (3,7,8) 1395,(3,7,11) 1397,(3,7,12) 1398,(3,7,13) 1395,(3,8,10) 1395,(3,8,12) 1395,(3,8,13) 1395,(3,10,13) 1397,(3,12,13) 1397,(3,13,14) 1397; ninguna mejora.

- I-089, tríos 281-315: 30 cerradas OPTIMAL en 1401; abiertas: (4,6,13) 1398,(4,7,13) 1396,(4,10,13) 1397,(4,11,13) 1397,(4,12,13) 1397; ninguna mejora.

- I-089, tríos 316-350: 29 cerradas OPTIMAL en 1401; abiertas: (5,7,8) 1398,(5,7,12) 1398,(5,7,13) 1397,(5,8,13) 1398,(5,10,13) 1397,(6,7,8) 1395; ninguna mejora.

- I-089, tríos 351-385: 22 cerradas OPTIMAL en 1401; abiertas: (6,7,13) 1394,(6,8,12) 1397,(6,8,13) 1395,(6,10,13) 1395,(6,11,13) 1397,(6,12,13) 1400,(7,8,9) 1397,(7,8,10) 1396,(7,8,12) 1392,(7,8,13) 1393,(7,8,14) 1397,(7,9,13) 1396,(7,10,13) 1395; ninguna mejora.
