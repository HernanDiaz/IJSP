...
#define PROBLEM_DUEDATES "problem.duedates"
	  ...
	  * Problem (JSP in this version). The data is contained withing a file
	...
	class ProblemJSP : public FuzzyFW::Problem {
		//=====================================================================
		//		FIELDS
		//=====================================================================
	protected:
	...
	public:
		...
		* Default constructor
		*/
		ProblemJSP(const FuzzyFW::ParameterDB *params = NULL);


		/**
		* Sets the problem file, but does not load it
		*/
		ProblemJSP(const char *inputFile);
		...
		*/
		ProblemJSP(const FuzzyFW::ParameterDB *params, const char *inputFile);
		...
		* Copy constructor
		*/
		ProblemJSP(const ProblemJSP & source);
	...
	public:
		...
		*/
		TaskJSP * getTask(const unsigned int taskId) const;
	...
	public:
		...
		* allowed
		*/
		const TaskJSP * operator[](const int taskId) const {
