...
* Problem (FJSP in this version). The data is contained withing a file
...
class ProblemFJSP : public FuzzyFW::Problem {
	//=====================================================================
	//		FIELDS
	//=====================================================================
protected:
...
public:
	...
	* Default constructor
	*/
	ProblemFJSP(const FuzzyFW::ParameterDB *params = NULL);


	/**
	* Sets the problem file, but does not load it
	*/
	ProblemFJSP(const char *inputFile);
	...
	*/
	ProblemFJSP(const FuzzyFW::ParameterDB *params, const char *inputFile);
	...
	* Copy constructor
	*/
	ProblemFJSP(const ProblemFJSP & source);
...
public:
	...
	*/
	const TaskFJSP * getTask(const unsigned int taskId) const;
...
public:
	...
	* allowed
	*/
	const TaskFJSP * operator[](const int taskId) const {
