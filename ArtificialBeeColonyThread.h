...
#define ELITE_SELECTION "elite.selection"  //Selection mechanism to select the elite for crossing.
	...
	*
	*/
	class ArtificialBeeColonyThread : public GeneticAlgorithm {
		//=========================================================================
		//		FIELDS
		//=========================================================================
	protected:
	...
	public:
		...
		*/
		explicit ArtificialBeeColonyThread(ParameterDB *params = NULL);

		/**
		* Destructor
		*/
		virtual ~ArtificialBeeColonyThread();
	...
	public:
		...
		*/
		...
		//void processFoodSource(Population *currentPopulation, int i, Individual* bestFoodSource);
		//Individual* processFoodSource(const Individual* currentFoodSource, const Individual* bestFoodSource, Individual* &result);
		Individual* processFoodSource(const Individual* currentFoodSource, const Individual* bestFoodSource);

		void processFoodSourceThread(Population *currentPopulation, int i, Individual* bestFoodSource);
	protected:
		/**
