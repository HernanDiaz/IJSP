/*
 * NeighbourhoodJSP_N1.cpp
 *
 *  Created on: Oct 12, 2019
 *      Author: hdiaz
 */

#include "NeighbourhoodJSP_N1.h"

namespace JSP {

//-----  Find neighbours  -----------------------------------------------------
unsigned int NB_ParallelN1_MakespanJSP::findNewNeighbours(
...
FuzzyFW::Fitness *NB_ParallelN1_MakespanJSP::evaluateNeighbour(
...
void NB_ParallelN1_MakespanJSP::acceptNeighbour(const unsigned int idx,
	const FuzzyFW::SharedVars *svars) {
	int job;
	int z, msz, jsz;
