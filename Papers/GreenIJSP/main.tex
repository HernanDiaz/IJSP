...
\todo{Pareto arms pending (hypervolume, $\varepsilon$-indicator vs
reference and exact fronts); engine choice and irace re-tuning per arm
(scalarised on hypervolume with fixed per-instance reference points) to
be decided.}
