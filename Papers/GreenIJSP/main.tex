...
marked. NOTE: current probe fronts are computed on the midpoint scenario
(crisp proxy) — either state this explicitly or upgrade the probe to the
exact interval model (shared sequencing booleans + two timing copies for
$p^-/p^+$ with LEX2 objectives, as in the multi-component MILP of
\cite{Afsar2022}); upgrade planned for the validation instances only.}
