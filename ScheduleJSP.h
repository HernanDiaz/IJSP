...
struct ScheduledTaskInfo {
	const TaskJSP *task;	// Scheduled task
...
//=========================================================================
/**
* Objects of this class represent a [partial] solution to a JSP. We
...
*
*/
class ScheduleJSP : public FuzzyFW::Solution
{
	//=====================================================================
	//		FIELDS
	//=====================================================================
...
public:
	...
	* Main constructor
	*/
	ScheduleJSP(const ProblemJSP * problem = NULL);

	/**
	* Copy constructor
	*/
	ScheduleJSP(const ScheduleJSP & source);
...
public:
	...
	* Assignment overload
	*/
	ScheduleJSP & operator=(const ScheduleJSP & source);
	...
	*/
	const TaskJSP * operator[](const unsigned int index) const;
