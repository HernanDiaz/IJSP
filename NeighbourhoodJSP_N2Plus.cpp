/*
 * NeighbourhoodJSP_N2Plus.cpp
 *
 *  Created on: Oct 12, 2019
 *      Author: hdiaz
 */

#include "NeighbourhoodJSP_N2Plus.h"
#include <iostream>
namespace JSP {
...
unsigned int NB_ParallelN2Plus_MakespanJSP::findNewNeighbours(
	...
	// This neighbourhood walked G+ only, the critical graph of the upper
	// endpoint. On crisp times there is one endpoint, so G+ is the critical
	// graph and this is the same neighbourhood as jsp.makespan.n2.
