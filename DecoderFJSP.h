...
public:
	...
	* Default constructor
	*/
	DecoderFJSP(FuzzyFW::ParameterDB *parameters = NULL)
...
public:
	...
	* Default constructor
	*/
	DecoderFJSP_Order(FuzzyFW::ParameterDB *parameters = NULL)
...
public:
	...
	* Default constructor
	*/
	DecoderFJSP_JobOrder(FuzzyFW::ParameterDB *parameters = NULL)
		: DecoderFJSP(parameters) { }
